            ...
            <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-8 py-10 md:py-14">
                ...
                <div className="relative z-10 max-w-xl">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <button className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-smooth">
                            Browse Templates
                        </button>
    ...
    return (
        ...
        >
            ...
            ${hovered
                ...
                >
                    {hovered ? '+ Add to Workspace' : 'Install Agent'}
                </button>
            </div>
        </div>
    );
