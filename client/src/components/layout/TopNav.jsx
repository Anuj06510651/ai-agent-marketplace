            ...
            <div className="flex items-center justify-between px-6 py-3">
                ...
                <div className="flex items-center gap-3 shrink-0">
                    <div className="hidden sm:block text-right">
                        ...
                        <p className="text-sm font-semibold text-slate-800">{user?.name || user?.email || 'User'}</p>
                    </div>
                    <button
                        type="button"
                        onClick={onLogout}
                        className="hidden sm:flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold rounded-lg transition-smooth"
                    >
                        Logout
                    </button>
                </div>
